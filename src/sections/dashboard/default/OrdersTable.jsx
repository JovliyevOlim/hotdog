...
export default function OrderTable() {
    const {reportPurchaseProducts, isSuccess, isLoading} = useSelector((state) => state.report);
    ...
    return (
        <Box>
            <Grid container alignItems="center" justifyContent="space-between">
                <Grid>
                    <Typography variant="h5">Xaridlar</Typography>
                </Grid>
                <Grid>
            ...
            <MainCard sx={{mt: 2}} content={false}>
                {
                    isLoading ? <Spinner/> :
                        reportPurchaseProducts && reportPurchaseProducts?.content?.length > 0 ?
                            <TableContainer
                                sx={{
                                    width: '100%',
                                    overflowX: 'auto',
                            ...
                            >
                                <Table aria-label="common table">
                                    ...
                                    <TableBody>
                                        {reportPurchaseProducts?.content.map((row, index) => (
                                            <TableRow
                                                hover
                                                key={index}
                ...
                <TablePagination
                    component="div"
                    count={reportPurchaseProducts?.content?.length}
                    page={page}
